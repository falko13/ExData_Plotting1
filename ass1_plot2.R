...
#build plot 
with(df_subset, plot(Time,Global_active_power,type = "l", xlab=NA, ylab = "Global Active Power (kilowatts)"))

#copy window-graphics plot to png-file and close png-device
dev.copy(png, file = "ass1_plot2.png")
dev.off()
