...
par(mfrow = c(2,2), mar = c(5.1, 4.1, 3.2, 1.4), oma = c(0,0,0,0), bg = "transparent",pty = "m")
with(df_subset, {
        plot(Time,Global_active_power,type = "l", ylab = "Global Active Power",xlab=NA)
